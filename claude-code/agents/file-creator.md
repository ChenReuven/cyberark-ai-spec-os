...
- Tasks: @.cyberark-spec-os/specs/[FOLDER]/tasks.md
- Technical Specification: @.cyberark-spec-os/specs/[FOLDER]/sub-specs/technical-spec.md
[ADDITIONAL_DOCS]
```
...
This is the technical specification for the spec detailed in @.cyberark-spec-os/specs/[FOLDER]/spec.md
...
This is the database schema implementation for the spec detailed in @.cyberark-spec-os/specs/[FOLDER]/spec.md
...
This is the API specification for the spec detailed in @.cyberark-spec-os/specs/[FOLDER]/spec.md
...
This is the tests coverage details for the spec detailed in @.cyberark-spec-os/specs/[FOLDER]/spec.md
...
These are the tasks to be completed for the spec detailed in @.cyberark-spec-os/specs/[FOLDER]/spec.md
...
### Single File Request
```
Create file: .cyberark-spec-os/specs/2025-01-29-auth/spec.md
...
Directory: .cyberark-spec-os/specs/2025-01-29-user-auth/
Files:
...
Directory: .cyberark-spec-os/product/
Files:
...
### Success
```
✓ Created directory: .cyberark-spec-os/specs/2025-01-29-user-auth/
