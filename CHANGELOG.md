...
`curl -sSL https://raw.githubusercontent.com/ChenReuven/cyberark-ai-spec-os/master/setup/project.sh | bash -s -- --no-base --claude-code --cursor`
...
`curl -sSL https://raw.githubusercontent.com/ChenReuven/cyberark-ai-spec-os/master/setup/base.sh | bash -s -- --overwrite-instructions --claude-code --cursor`
