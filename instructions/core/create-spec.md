...
<option_a_flow>
  ...
  <actions>
    1. CHECK @.cyberark-spec-os/product/roadmap.md
...
Use the context-fetcher subagent to read @.cyberark-spec-os/product/mission-lite.md and @.cyberark-spec-os/product/tech-stack.md only if not already in context to ensure minimal context for spec alignment.
...
<intelligent_clarification>
  IF feature requirements are ambiguous OR scope is undefined:
    TRIGGER: @.cyberark-spec-os/instructions/meta/deep-clarification.md
    FOCUS: Feature purpose, scope boundaries, and success criteria
  ELSE:
    PROCEED: Requirements are clear for specification
</intelligent_clarification>
...
Use the file-creator subagent to create directory: .cyberark-spec-os/specs/YYYY-MM-DD-spec-name/ using the date from step 4.
...
Use the file-creator subagent to create the file: .cyberark-spec-os/specs/YYYY-MM-DD-spec-name/spec.md using this template:
...
Use the file-creator subagent to create the file: .cyberark-spec-os/specs/YYYY-MM-DD-spec-name/spec-lite.md for the purpose of establishing a condensed spec for efficient AI context usage.
...
<file_template>
  <header>
    ...
    This is the technical specification for the spec detailed in @.cyberark-spec-os/specs/YYYY-MM-DD-spec-name/spec.md
  </header>
</file_template>
...
<file_template>
  <header>
    ...
    This is the database schema implementation for the spec detailed in @.cyberark-spec-os/specs/YYYY-MM-DD-spec-name/spec.md
  </header>
</file_template>
...
<file_template>
  <header>
    ...
    This is the API specification for the spec detailed in @.cyberark-spec-os/specs/YYYY-MM-DD-spec-name/spec.md
  </header>
</file_template>
...
<review_request>
  ...
  - Spec Requirements: @.cyberark-spec-os/specs/YYYY-MM-DD-spec-name/spec.md
  - Spec Summary: @.cyberark-spec-os/specs/YYYY-MM-DD-spec-name/spec-lite.md
  - Technical Spec: @.cyberark-spec-os/specs/YYYY-MM-DD-spec-name/sub-specs/technical-spec.md
