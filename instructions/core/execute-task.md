...
Use the context-fetcher subagent to retrieve relevant sections from @.cyberark-spec-os/standards/best-practices.md that apply to the current task's technology stack and feature type.
...
Use the context-fetcher subagent to retrieve relevant code style rules from @.cyberark-spec-os/standards/code-style.md for the languages and file types being used in this task.
