...
Use the project-manager subagent to read @.cyberark-spec-os/product/roadmap.md and mark roadmap items as complete with [x] ONLY IF the executed tasks have completed any roadmap item(s) and the spec completes that item.
...
Use the project-manager subagent to create a recap document in .cyberark-spec-os/recaps/ folder that summarizes what was built for this spec.

<instructions>
  ACTION: Use project-manager subagent
  REQUEST: "Create recap document for current spec:
            - Create file: .cyberark-spec-os/recaps/[SPEC_FOLDER_NAME].md
...
<recap_template>
  ...
  This recaps what was built for the spec documented at .cyberark-spec-os/specs/[spec-folder-name]/spec.md.
...
<file_creation>
  <location>.cyberark-spec-os/recaps/</location>
